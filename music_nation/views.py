...
def album_list(request):
    albums = Album.objects.filter(
        Q(visibility='public') | Q(album_artist=request.user)
    ).order_by('-uploaded_on')  # optional: show latest first
    return render(request, 'music_nation/album_list.html', {'albums': albums})
#........................................................#
